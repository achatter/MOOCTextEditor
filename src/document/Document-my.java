	...
	protected int countSyllables(String word)
	{
		...
		for(int j = 0; j < word.length(); j++){
		     ...
		     switch(word.charAt(j)) {
		         case 'a':
		         case 'e':
		        	 if (count != 0 && j == word.length()-1)
		        	 {	
		        		 //System.out.println("word ending in e");
		        		 break;
		        	 }
		         case 'i':
		         case 'o':
		         ...
		         case 'Y':
		        	 ...
		        	 //System.out.println("At " + j + " character " + word.charAt(j));
		        	 if (j != 0){ 
		        		 	tempChar = word.charAt(j-1);
		        		 	//System.out.println("TempChar is "+ tempChar);
		        	 }
		        	 if(j != 0 && (tempChar != 'a' && tempChar != 'e'&& tempChar!='i'&& word.charAt(j-1) != 'o' && word.charAt(j-1) != 'u' && word.charAt(j-1) != 'y')){
		        		 count++;
		        	 }
		        	 else if(j == 0){
		        		 count ++;
		...
		//System.out.println("# of syllables = " + count);
		return count;
	}
